...
//import com.mygdx.game.entity.TextureHandler;
...
// */
//public class ChunkHandler implements TextureHandler {
...
//        textureRegionList.add(new TextureRegion(getTexture(), getSSR() * (1f / 3), 0f, ((getSSR() + 1) / 3f), 1 / 4f));
//        getSpriteList().add(new Sprite(new TextureRegion()));
